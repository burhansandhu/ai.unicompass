      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        ...
        <main className="flex-1 p-4 sm:p-8 space-y-8 max-w-7xl w-full mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-[#667085] mt-1">
                Here&apos;s your study-abroad application overview and milestone tracker.
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {statCards.map((stat) => (
              <Card key={stat.title} hoverable className="p-5 flex flex-col justify-between border-[#E7EAF0]">
                ...
                <div>
                  <div className="text-2xl sm:text-3xl font-extrabold text-[#152033]">
                    {stat.count}
                  </div>
          ...
          <Card className="p-6 border-[#E7EAF0] bg-white">
            <h3 className="font-bold text-base text-[#152033] border-b border-[#E7EAF0] pb-3 mb-4">
              Registered Profile Details
            </h3>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
              <div>
                <span className="text-[#667085] uppercase font-semibold text-[10px]">Full Name</span>
                <p className="font-bold text-sm text-[#152033] mt-0.5">{user.full_name}</p>
              </div>
              <div>
                <span className="text-[#667085] uppercase font-semibold text-[10px]">Registered Email</span>
                <p className="font-bold text-sm text-[#152033] mt-0.5">{user.email}</p>
              </div>
              <div>
                <span className="text-[#667085] uppercase font-semibold text-[10px]">Access Role</span>
                <p className="font-bold text-sm text-[#3157E8] capitalize mt-0.5">{user.role} Portal</p>
              </div>
              <div>
                <span className="text-[#667085] uppercase font-semibold text-[10px]">Account ID</span>
                <p className="font-bold text-sm text-[#152033] mt-0.5">UC-{user.id.toString().padStart(5, "0")}</p>
              </div>
            </div>
          </Card>
        </main>
